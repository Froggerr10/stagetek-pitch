    ...
    return (
        <div className="w-full max-w-7xl mx-auto px-6 md:px-8 py-6 md:py-16 flex flex-col justify-center h-full">
            ...
            <div className="flex flex-col items-center justify-center relative">
                ...
                >
                    <div className="bg-gray-800/50 border border-gray-700 rounded-t-3xl p-4 md:p-8 text-center relative overflow-hidden">
                        <div className="absolute top-0 left-0 w-full h-1 bg-gray-600" />
                        <h3 className="text-base md:text-2xl font-bold text-gray-400 mb-1 md:mb-2">TAM - Mercado Total</h3>
                        <p className="text-2xl md:text-4xl font-black text-white">US$ 180-200M</p>
                ...
                >
                    <div className="bg-stagetek-red/20 backdrop-blur-md border border-stagetek-red/30 rounded-t-3xl p-4 md:p-8 text-center relative overflow-hidden shadow-[0_0_50px_rgba(233,1,1,0.1)]">
                        <div className="absolute top-0 left-0 w-full h-1 bg-stagetek-red/50" />
                        <h3 className="text-base md:text-2xl font-bold text-stagetek-red mb-1 md:mb-2">SAM - Mercado Alvo</h3>
                        <p className="text-3xl md:text-5xl font-black text-white">US$ 30-35M</p>
                ...
                >
                    <div className="bg-white text-black rounded-xl p-4 md:p-8 text-center relative overflow-hidden shadow-[0_0_50px_rgba(255,255,255,0.2)]">
                        <div className="absolute top-0 left-0 w-full h-1 bg-stagetek-red" />
                        <h3 className="text-base md:text-2xl font-bold text-gray-800 mb-1 md:mb-2">SOM - Alcançável</h3>
                        <div className="flex items-center justify-center gap-4">
                            <div>
                                <p className="text-sm text-gray-500 font-bold">2025</p>
                                <p className="text-xl md:text-3xl font-black text-black">US$ 0.6M</p>
                            </div>
                            <div className="text-stagetek-red">→</div>
                            <div>
                                <p className="text-sm text-gray-500 font-bold">2027</p>
                                <p className="text-xl md:text-3xl font-black text-black">US$ 1.8M</p>
                            </div>
                        </div>
