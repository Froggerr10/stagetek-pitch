...
const ClosingSlide = () => {
    ...
    return (
        <div className="w-full max-w-7xl mx-auto px-6 md:px-8 py-6 md:py-14 flex flex-col justify-center h-full text-center">
            ...
            >
                <h2 className="text-2xl sm:text-4xl md:text-6xl font-bold text-white mb-3 md:mb-6">
                ...
                <div className="mt-4 md:mt-8 p-4 md:p-6 bg-white/5 rounded-xl border border-white/10 max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-8 mb-5 md:mb-12">
                <motion.div
                    initial={{ opacity: 0, y: 30 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.5, delay: 0.2 }}
                    className="bg-white/5 rounded-2xl p-5 md:p-8 border border-white/10"
                >
                    <h3 className="text-gray-400 text-xs uppercase tracking-wider mb-1 md:mb-2">Aporte Inicial</h3>
                    <p className="text-2xl md:text-4xl font-black text-white">R$ 600 mil</p>
                ...
                <motion.div
                    ...
                    className="bg-white/5 rounded-2xl p-5 md:p-8 border border-white/10"
                >
                    <h3 className="text-gray-400 text-xs uppercase tracking-wider mb-1 md:mb-2">Uso do Capital</h3>
                    <p className="text-xl md:text-3xl font-black text-stagetek-red">Estoque + Nacionalização</p>
                ...
                <motion.div
                    ...
                    className="bg-white/5 rounded-2xl p-5 md:p-8 border border-white/10"
                >
                    <h3 className="text-gray-400 text-xs uppercase tracking-wider mb-1 md:mb-2">Modelo de Retorno</h3>
                    <p className="text-xl md:text-3xl font-black text-white">Resultado por Ciclo</p>
                    <p className="text-sm text-gray-500 mt-2">Participação vinculada à venda do lote</p>
                </motion.div>
            </div>

            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4 mb-4 md:mb-12 max-w-3xl mx-auto w-full">
            ...
            >
                <button className="group bg-stagetek-red hover:bg-red-600 text-white text-base md:text-xl font-bold py-3 md:py-4 px-8 md:px-12 rounded-full transition-all flex items-center gap-3 mx-auto shadow-[0_0_30px_rgba(233,1,1,0.3)] hover:shadow-[0_0_50px_rgba(233,1,1,0.5)]">
