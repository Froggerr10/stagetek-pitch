...
import { ArrowDown, ArrowLeft, ArrowRight, ArrowRightLeft, ArrowUp } from 'lucide-react';
...
const PaymentFlowSlide = () => {
    return (
        <div className="w-full max-w-7xl mx-auto px-4 flex flex-col justify-center h-full text-sm md:text-base overflow-y-auto md:overflow-visible py-8 md:py-0">
            <motion.div
                initial={{ opacity: 0, y: -20 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8 }}
                className="text-center mb-6 md:mb-4 shrink-0"
            >
                <h2 className="text-2xl md:text-5xl font-bold text-white mb-2 uppercase">
            ...
            {/* MOBILE LAYOUT (< md) */}
            <div className="flex flex-col items-center gap-4 md:hidden w-full pb-20">
                {/* 1. Cliente */}
                <div className="w-full max-w-xs">
                    <FlowNode>
                        <p className="font-bold text-white">Cliente Final</p>
                        <p className="text-xs text-gray-300">R$ 100.000</p>
                    </FlowNode>
                </div>
                ...
                {/* 3. Gateway & Bandeira */}
                <div className="w-full max-w-xs p-3 border border-white/10 rounded-lg bg-white/5">
                    <p className="text-xs text-center text-gray-400 mb-2">Processamento</p>
                    <div className="flex gap-2">
                        <FlowNode className="flex-1 text-[10px]">
                            <p className="font-bold text-white">Gateway</p>
                        </FlowNode>
                        <ArrowRightLeft className="text-gray-500 w-4 h-4 self-center" />
                        <FlowNode className="flex-1 text-[10px]">
                            <p className="font-bold text-white">Bandeira</p>
                        </FlowNode>
                    </div>
                </div>
                <ArrowDown className="text-gray-500 w-5 h-5" />
                ...
                <div className="w-full max-w-xs">
                    <FlowNode className="border-blue-500/50 bg-blue-500/10">
                        ...
                        <p className="text-xs text-blue-200">Divisão Automática</p>
                    </FlowNode>
                </div>
                ...
                <div className="grid grid-cols-1 gap-3 w-full max-w-xs mt-2">
                    <div className="flex items-center gap-2">
                        ...
                        <FlowNode className="flex-1 border-green-500/30 text-left pl-4">
                            <p className="font-bold text-white text-xs">EC (Lojista)</p>
                            <p className="text-[10px] text-green-400">R$ 60.000 (Líquido)</p>
                        </FlowNode>
                    </div>
                    <div className="flex items-center gap-2">
                        <ArrowRight className="text-gray-500 w-4 h-4" />
                        <FlowNode className="flex-1 text-left pl-4">
                            <p className="font-bold text-white text-xs">Parceiros</p>
                            <p className="text-[10px] text-gray-300">R$ 40.000</p>
                        </FlowNode>
                    </div>
                    <div className="flex items-center gap-2">
                        <ArrowRight className="text-gray-500 w-4 h-4" />
                        <FlowNode className="flex-1 text-left pl-4">
                            <p className="font-bold text-white text-xs">Taxas</p>
                            <p className="text-[10px] text-gray-300">MDR / Antecipação</p>
                        </FlowNode>
                    </div>
                </div>

                {/* Resultado */}
                <div className="w-full max-w-xs mt-4 border border-white/20 rounded-lg p-3 bg-white/5">
                    <p className="font-bold text-white mb-1 border-b border-white/10 pb-1 text-xs">Vantagens:</p>
                    <ul className="text-xs text-gray-300 space-y-1 list-disc pl-4">
                        <li>Operação automatizada</li>
                        <li>Conciliação simplificada</li>
                        <li>Menor custo bancário</li>
                    </ul>
                </div>
            </div>
            ...
            <div className="hidden md:block">
                <div className="relative w-full max-w-5xl mx-auto h-[700px] bg-white/0 rounded-xl overflow-hidden text-xs md:text-sm">
                    ...
                    <svg className="absolute inset-0 w-full h-full pointer-events-none z-0 opacity-50" viewBox="0 0 1024 700" preserveAspectRatio="xMidYMid meet">
                        ...
                        <path d="M 384 280 Q 317 240 250 280" stroke="#6b7280" strokeWidth="1" fill="none" markerEnd="url(#arrowhead)" />

                        {/* 4) Bandeira Right (250) -> Gateway Left (384) - Curved DOWN */}
                        <path d="M 250 320 Q 317 360 384 320" stroke="#6b7280" strokeWidth="1" fill="none" markerEnd="url(#arrowhead)" />
                    ...
                    <div className="absolute top-[270px] w-48 z-10 left-[15%] -translate-x-1/2">
                        <FlowNode>
                    ...
                    <div className="absolute top-[245px] text-[10px] text-gray-400 w-32 text-center left-[31%] -translate-x-1/2">
                        3) Solicita autorização
                    </div>
                    <div className="absolute top-[335px] text-[10px] text-gray-400 w-32 text-center left-[31%] -translate-x-1/2">
                        4) Devolve autorização aprovada
                    </div>

                    {/* Label 5 */}
                    <div className="absolute top-[350px] text-[10px] text-gray-400 w-40 text-left left-[53%]">
